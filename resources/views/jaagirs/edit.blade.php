            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {{--<form class="form-horizontal" role="form" method="PATCH" action="{{ url(['JaagirsController@update', $jaagir->id]) }}">--}}

                            {!! Form::model($jaagir, ['method' => 'PATCH','action' => ['JaagirsController@update', $jaagir->id], 'class'=> 'form-horizontal']) !!}
                            ...
                            <div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="location" value="{{$jaagir -> location}}">
                            ...
                            <div class="form-group{{ $errors->has('apply_website') ? ' has-error' : '' }}">
                                <label class="col-md-4 control-label">Apply Website</label>
